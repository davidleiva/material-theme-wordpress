...
class QuadMenu_Welcome extends QuadMenu_Panel {
  ...
  function add_menu() {
    add_menu_page(self::$panel_slug, QUADMENU_PLUGIN_NAME, 'edit_posts', self::$panel_slug, array($this, 'add_panel'), plugins_url('/assets/backend/images/icon.png', QUADMENU_PLUGIN_FILE));
