          ...
          'fields' => array(
              ...
              array(
                  ...
                  'options' => array(
                      'embed' => array(
                          ...
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/embed.png'
                      ),
                      'collapse' => array(
                          'alt' => esc_html__('Collapse', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/collapse.png'
                      ),
                      'offcanvas' => array(
                          'alt' => esc_html__('Offcanvas', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/offcanvas.png'
                      ),
                      'vertical' => array(
                          'alt' => esc_html__('Vertical', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/vertical.png'
                      ),
                      'inherit' => array(
                          'alt' => esc_html__('Inherit', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/inherit.png'
                      ),
                  ),
              ...
              array(
                  ...
                  'options' => array(
                      'left' => array(
                          ...
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/fleft.png'
                      ),
                      'right' => array(
                          'alt' => esc_html__('Right', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/fright.png'
                      ),
                  ),
                  'required' => array(
              ...
              array(
                  ...
                  'options' => array(
                      'left' => array(
                          'alt' => esc_html__('Left', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/aleft.png'
                      ),
                      'center' => array(
                          'alt' => esc_html__('Center', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/acenter.png'
                      ),
                      'right' => array(
                          'alt' => esc_html__('Right', 'quadmenu'),
                          'img' => QUADMENU_PLUGIN_URL . 'assets/backend/images/layouts/aright.png'
                      ),
                  ),
                  'required' => array(
