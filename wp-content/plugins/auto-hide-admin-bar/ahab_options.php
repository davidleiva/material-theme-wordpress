...
function ahab_plugin_options_init() {
	...
	add_settings_section( 'ahab_plugin_section_visual', __( 'Visual options',
		'auto-hide-admin-bar' ), 'ahab_plugin_section_visual_text', 'ahab_plugin' );
	add_settings_field( 'ahab_plugin_option_arrow', __( 'Show or hide an arrow:', 'auto-hide-admin-bar' ),
		'ahab_plugin_setting_arrow', 'ahab_plugin', 'ahab_plugin_section_visual' );
	add_settings_field( 'ahab_plugin_option_arrow_position', __( 'Arrow position:', 'auto-hide-admin-bar' ),
		'ahab_plugin_setting_arrow_position', 'ahab_plugin', 'ahab_plugin_section_visual' );
	...
	add_settings_section( 'ahab_plugin_section_keyboard_shortcut', __( 'Keyboard shortcut',
		'auto-hide-admin-bar' ), 'ahab_plugin_section_keyboard_shortcut_text', 'ahab_plugin' );
	add_settings_field( 'ahab_plugin_option_keyboard_shortcut', __( 'Set keyboard shortcut to:', 'auto-hide-admin-bar' ),
		'ahab_plugin_setting_keyboard_shortcut', 'ahab_plugin', 'ahab_plugin_section_keyboard_shortcut' );
}
...
function ahab_plugin_setting_arrow() {
	...
	<p>
		...
		<label for="ahab_setting_mobile"><?php _e( 'No arrow', 'auto-hide-admin-bar' ); ?></label>
	</p>
	<p>
		<input type="radio" id="ahab_setting_arrow" name="ahab_plugin_options[arrow]" value="2" <?php checked( 2, $options_arrow, true ); ?> />
		<label for="ahab_setting_mobile"><?php _e( 'Show an arrow', 'auto-hide-admin-bar' ); ?></label>
	</p>
	<?php
}
...
function ahab_plugin_setting_keyboard_shortcut() {
	...
	$ahab_keyboard_shortcut_character = ( ! empty( $options[ 'keyboard_shortcut_char' ] ) ) ? $options[ 'keyboard_shortcut_char' ] : '';
	?>
	<p>
