...
<div class="style-17 <?php echo ! empty( $position ) ? $position : ''; ?>
 <?php echo apply_filters( 'wp_dark_mode/switch_label_class', 'wp-dark-mode-side-toggle-wrap wp-dark-mode-ignore' ); ?>">
    ...
    <div class="wp-dark-mode-side-toggle wp-dark-mode-toggle wp-dark-mode-switcher wp-dark-mode-ignore">
        ...
        <svg  class="wp-dark-mode-ignore mode-light not-fill" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24">
        ...
        <svg class="wp-dark-mode-ignore mode-dark not-fill" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
