...
<div class="style-16 <?php echo ! empty( $position ) ? $position : ''; ?>
 <?php echo apply_filters( 'wp_dark_mode/switch_label_class', 'wp-dark-mode-side-toggle-wrap wp-dark-mode-ignore' ); ?>">
    ...
    <div class="wp-dark-mode-side-toggle wp-dark-mode-toggle wp-dark-mode-switcher wp-dark-mode-ignore">
        ...
        <svg class="wp-dark-mode-ignore mode-light" xmlns="http://www.w3.org/2000/svg" width="16.5" height="16.5" viewBox="0 0 16.5 16.5">
        ...
        <svg class="wp-dark-mode-ignore mode-dark" xmlns="http://www.w3.org/2000/svg" width="15.861" height="17.292" viewBox="0 0 15.861 17.292">
