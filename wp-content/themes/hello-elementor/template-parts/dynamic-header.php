...
$header_nav_menu = wp_nav_menu( [
	...
	'fallback_cb' => false,
	'echo' => false,
	'add_li_class'  => 'Menu__Item align-items-center'
] );
?>
<header id="Header site-header" class="Header site-header dynamic-header <?php echo esc_attr( hello_get_header_layout_class() ); ?>" role="banner">
	<div class="Header__TopHeader">
		<div class="container">
			<button class="btn btn--hasIcon btn-sm btn btn-outline-light border-0 fw-normal">
				<span class="material-icons btn__icon">phone</span>911 984 986
			</button>
			<button class="btn btn--hasIcon btn-sm btn btn-outline-light border-0 fw-normal isDropdown">
			<span class="material-icons btn__icon">language</span>Español</button>
			<button class="btn btn--hasIcon btn-sm btn btn-outline-light border-0 fw-normal">
				<span class="material-icons btn__icon">login</span>Acceder</button>
		</div>
	</div>
		...
		<div class="header-inner">
			...
			<?php if ( $header_nav_menu ) : ?>
				<nav class="site-navigation <?php echo hello_show_or_hide( 'hello_header_menu_display' ); ?>" role="navigation">
					...
					<button type="button" class="btn btn-warning btn--Small">Contratar</span>
					</button>

					<section class="MegaMenu mdc-elevation--z3">
						<div class="container">
							<div class="row">
								<div class="MegaMenu__Summary col-4">
								...
								<div class="MegaMenu__SubMenu col-8">
